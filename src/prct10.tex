...
\begin{document}
\title{Número $\pi$}
\author{María Jesús Álvarez Rodríguez}
...
El número pi, representado por la letra griega ?, equivale a la constante que relaciona el perímetro o longitud de una 
